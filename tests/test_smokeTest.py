...
class TestSmokeTest():
  ...
  def test_test1(self):
    self.driver.get("https://julirey.github.io/cse270-teton/")
  ...
  def test_test3(self):
    self.driver.get("https://julirey.github.io/cse270-teton/directory.html")
  ...
  def test_test4(self):
    self.driver.get("https://julirey.github.io/cse270-teton/join.html")
  ...
  def test_test5(self):
    self.driver.get("https://julirey.github.io/cse270-teton/admin.html")
